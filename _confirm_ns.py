...
brun("grep -a 'speex denoise\\|ALSA\\|AUDIO' /tmp/rtc_run.log | head -5; echo '== 进程 =='; pgrep -af '[r]v1126b_webrtc_push' | grep -v bash || echo '(未运行)'; echo '== 增益确认 =='; amixer -c 0 sget 'ACodec_LP Digital Gain' 2>&1 | grep 'Mono:' | tail -1", "降噪/进程/增益确认", 20)
